...
const String ksAiMlEnthusiast = "Trader";
...
const String ksWorkEmail = "ashiashik5047@gmail.com";
const String ksWorkPhone = "+91 8137845903";
...
const String ksCC = "©️ 2024 Muhammed Ashik";
const String ksYoung = "When I was young, I was a kid!";
const String ksNobody = "I'm Ashik";
const String ksSpecialization = "A dedicated and passionate Mobile Technologies specialist, actively pursuing a Master's degree in Computer Application (MCA) while holding a Bachelor's degree in Computer Application (BCA). I am driven by a deep commitment to developing high-quality applications and solving complex problems with innovative solutions. With a solid foundation in programming, problem-solving, and database management, I am eager to leverage my technical expertise to contribute to cutting-edge technology solutions. My enthusiasm for open-source projects and AI further fuels my ambition to excel in the IT sector.";

// "I specialize in Mobile Technologies and highly passionate about developing quality applications, problem solver";
...
final List<Certificate> ksCertificateList = [
  Certificate(
    name: 'Flutter Developer Certificate (Simplilearn)',
  ...
  Certificate(
    name: "Learn Advanced SQL (CodeChef)",
    image: kaPythonCerti,
    link: "",
  ),
  Certificate(
    name: "Problem Solving in Pythn(CodeChef)",
    image: kaJSTCerti,
    link: "",
  ),
  Certificate(
...
const String ksGithubLink = 'https://github.com/SDE-Ashik';
const String ksLinkedInLink = 'hhttps://www.linkedin.com/in/muhammed-ashik-s/';
...
final List<ShowcaseProject> ksShowcaseProjects = [
  ShowcaseProject(
    ...
    link: ProjectInfo(
      ...
      contents: [
        ...
        "https://github.com/myportfolio-Steve/pulse_x",
      ],
    ),
    heroTag: 'pulse-x',
    tags: ProjectInfo(
  ...
  ShowcaseProject(
    ...
    link: ProjectInfo(
        ...
        isLink: true,
        contents: [
          "https://github.com/myportfolio-Steve/notee",
        ]),
    heroTag: 'notee',
    tags: ProjectInfo(
      icon: kiTag,
  ...
  ShowcaseProject(
    ...
    link: ProjectInfo(
      ...
      isLink: true,
      contents: [
        "https://github.com/myportfolio-Steve/thread_logo_animation",
      ],
    ),
  ...
  ShowcaseProject(
    ...
    link: ProjectInfo(
        ...
        contents: [
          ...
          "https://github.com/myportfolio-Steve/TheGoldenLand",
        ]),
  ...
  ShowcaseProject(
    ...
    link: ProjectInfo(
      ...
      contents: [
        ...
        "https://github.com/myportfolio-Steve/pretty_animated_buttons",
      ],
    ),
  ...
  ShowcaseProject(
    ...
    link: ProjectInfo(
      ...
      isLink: true,
      contents: [
        "https://github.com/myportfolio-Steve/FlappyIronman",
      ],
    ),
  ...
  ShowcaseProject(
    ...
    link: ProjectInfo(
      ...
      isLink: true,
      contents: [
        "https://github.com/myportfolio-Steve/AIChatbot",
      ],
    ),
    heroTag: 'ai_chat_bot',
    tags: ProjectInfo(
  ...
  ShowcaseProject(
    ...
    link: ProjectInfo(
      ...
      isLink: true,
      contents: [
        "https://github.com/myportfolio-Steve/graphql-associate-dev",
      ],
    ),
  ...
  ShowcaseProject(
    ...
    link: ProjectInfo(
      ...
      isLink: true,
      contents: [
        "https://github.com/myportfolio-Steve/design_patterns",
      ],
    ),
